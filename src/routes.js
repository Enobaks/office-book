  ...
  },
  {
    ...
    routes: [
      ...
      },
      {
        ...
        component: lazy(() =>
          import("./views/page-layouts/vertical/CollapseMenu")
        ),
      },
      {
        exact: true,
        ...
        component: lazy(() =>
          import("./views/page-layouts/vertical/RTLLayout")
        ),
      },
      {
        exact: true,
      ...
      },
      {
        ...
        component: lazy(() =>
          import("./views/page-layouts/horizontal/Static-v2")
        ),
      },
      {
        exact: true,
        ...
        component: lazy(() =>
          import("./views/page-layouts/horizontal/RTLLayout")
        ),
      },
      {
        exact: true,
      ...
      },
      {
        ...
        path: "/layout/light",
        component: lazy(() =>
          import("./views/page-layouts/extra-layouts/Light")
        ),
      },
      {
        exact: true,
        path: "/layout/dark",
        component: lazy(() =>
          import("./views/page-layouts/extra-layouts/Dark")
        ),
      },
      {
        exact: true,
        ...
        component: lazy(() =>
          import("./views/page-layouts/extra-layouts/ColorIcon")
        ),
      },
      {
        exact: true,
        ...
        component: lazy(() =>
          import("./views/page-layouts/extra-layouts/NavColor")
        ),
      },
      {
        exact: true,
        ...
        component: lazy(() =>
          import("./views/page-layouts/extra-layouts/Layout-2")
        ),
      },
      {
        exact: true,
        ...
        component: lazy(() =>
          import("./views/page-layouts/extra-layouts/Layout-22")
        ),
      },
      {
        exact: true,
        ...
        component: lazy(() =>
          import("./views/page-layouts/extra-layouts/Layout-3")
        ),
      },
      {
        exact: true,
        ...
        component: lazy(() =>
          import("./views/page-layouts/extra-layouts/Layout-4")
        ),
      },
      {
        exact: true,
        ...
        component: lazy(() =>
          import("./views/page-layouts/extra-layouts/Layout-42")
        ),
      },
      {
        exact: true,
        ...
        component: lazy(() =>
          import("./views/page-layouts/extra-layouts/Layout-5h")
        ),
      },
      {
        exact: true,
        ...
        component: lazy(() =>
          import("./views/page-layouts/extra-layouts/Layout-6")
        ),
      },
      {
        exact: true,
        ...
        component: lazy(() =>
          import("./views/page-layouts/extra-layouts/Layout-8")
        ),
      },
      {
        exact: true,
      ...
      },
      {
        ...
        path: "/basic/carousel",
        component: lazy(() =>
          import("./views/ui-elements/basic/BasicCarousels")
        ),
      },
      {
        exact: true,
        ...
        component: lazy(() =>
          import("./views/ui-elements/basic/BasicGridSystem")
        ),
      },
      {
        exact: true,
        path: "/basic/progress",
        component: lazy(() =>
          import("./views/ui-elements/basic/BasicProgress")
        ),
      },
      {
        exact: true,
      ...
      },
      {
        ...
        path: "/basic/tooltip",
        component: lazy(() =>
          import("./views/ui-elements/basic/BasicTooltips")
        ),
      },
      {
        exact: true,
        path: "/basic/popovers",
        component: lazy(() =>
          import("./views/ui-elements/basic/BasicPopovers")
        ),
      },
      {
        exact: true,
      ...
      },
      {
        ...
        component: lazy(() =>
          import("./views/ui-elements/advance/AdvanceAlert")
        ),
      },
      {
        exact: true,
        ...
        component: lazy(() =>
          import("./views/ui-elements/advance/AdvanceDatepicker")
        ),
      },
      {
        exact: true,
        ...
        component: lazy(() =>
          import("./views/ui-elements/advance/AdvanceTaskBoard")
        ),
      },
      {
        exact: true,
        ...
        component: lazy(() =>
          import("./views/ui-elements/advance/AdvanceLightBox")
        ),
      },
      {
        exact: true,
        ...
        component: lazy(() =>
          import("./views/ui-elements/advance/AdvanceModal")
        ),
      },
      {
        exact: true,
        ...
        component: lazy(() =>
          import("./views/ui-elements/advance/AdvanceNotification")
        ),
      },
      {
        exact: true,
        ...
        component: lazy(() =>
          import("./views/ui-elements/advance/AdvanceNestable")
        ),
      },
      {
        exact: true,
        ...
        component: lazy(() =>
          import("./views/ui-elements/advance/AdvancePNotify")
        ),
      },
      {
        exact: true,
        path: "/advance/rating",
        component: lazy(() =>
          import("./views/ui-elements/advance/AdvanceRating")
        ),
      },
      {
        exact: true,
        ...
        component: lazy(() =>
          import("./views/ui-elements/advance/AdvanceRangeSlider")
        ),
      },
      {
        exact: true,
        path: "/advance/slider",
        component: lazy(() =>
          import("./views/ui-elements/advance/AdvanceSlider")
        ),
      },
      {
        exact: true,
        ...
        component: lazy(() =>
          import("./views/ui-elements/advance/AdvanceSyntaxHighlighter")
        ),
      },
      {
        exact: true,
        path: "/advance/tour",
        component: lazy(() =>
          import("./views/ui-elements/advance/AdvanceTour")
        ),
      },
      {
        exact: true,
        ...
        component: lazy(() =>
          import("./views/ui-elements/advance/AdvanceTree")
        ),
      },
      {
        exact: true,
      ...
      },
      {
        ...
        component: lazy(() =>
          import("./views/applications/gallery/GalleryGrid")
        ),
      },
      {
        exact: true,
      ...
      },
      {
        ...
        component: lazy(() =>
          import("./views/applications/gallery/MasonryGallery")
        ),
      },
      {
        exact: true,
        ...
        component: lazy(() =>
          import("./views/applications/gallery/GalleryAdvance")
        ),
      },
      {
        exact: true,
        ...
        component: lazy(() =>
          import("./views/extensions/editors/ck-editor/EditorCkClassic")
        ),
      },
      {
        exact: true,
        ...
        component: lazy(() =>
          import("./views/extensions/editors/ck-editor/EditorCkBalloon")
        ),
      },
      {
        exact: true,
        ...
        component: lazy(() =>
          import("./views/extensions/editors/ck-editor/EditorCkInline")
        ),
      },
      {
        exact: true,
        ...
        component: lazy(() =>
          import("./views/extensions/editors/ck-editor/EditorCkDocument")
        ),
      },
      {
        exact: true,
        ...
        component: lazy(() =>
          import("./views/extensions/editors/EditorRichNib")
        ),
      },
      {
        exact: true,
        ...
        component: lazy(() =>
          import("./views/extensions/editors/EditorJoditWYSIWYG")
        ),
      },
      {
        exact: true,
      ...
      },
      {
        ...
        component: lazy(() =>
          import("./views/extensions/invoice/InvoiceSummary")
        ),
      },
      {
        exact: true,
