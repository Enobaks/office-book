        ...
        <div>
          ...
          >
            <div className="container">
              ...
              <div
                className={
                  active ? "rain navbar-collapse " : "dry navbar-collapse"
                }
                ...
                <ul className="navbar-nav my-2 my-lg-0 align-items-center">
                  ...
                  <li className="nav-item">
                    <Link className="nav-link" to="/auth/signin">
                      <button className="btn signup-btn">Login In</button>
                    </Link>
                  </li>
                  <li className="nav-item">
          ...
          <div className="main" id="main">
                  ...
                  <div className="row justify-content-md-center">
                    <div className="col-md-10">
                      ...
                      <p className="wow fadeInUp" data-wow-delay="0.2s">
                        First ever React admin template with Flat UI Interface.{" "}
                        <br className="hidden-xs" /> Its best choice for your
                        any complex project.
                      </p>
                      <button
                ...
                <div className="row  justify-content-md-center">
                  <div className="col-md-8">
                    <div className="services-content">
                      ...
                      <p className="wow fadeInUp" data-wow-delay="0.2s">
                        Datta Able is one of the finest Admin dashboard template
                        in its category. Premium admin dashboard with high end
                      ...
                      <div className="row">
                        ...
                        >
                          ...
                          <div className="services-description">
                            ...
                            <p>
                              Datta Able is one of unique dashboard template
                              which come with tons of ready to use feature. We
                              continuous working on it to provide latest updates
                              in digital market.
                            </p>
                          </div>
                        </div>
                        ...
                        >
                          ...
                          <div className="services-description">
                            ...
                            <p>
                              We are contantly working on Datta Able and improve
                              its performance too. Your definitely give higher
                              rating to Datta Able for its performance.
                            </p>
                          </div>
                        </div>
                        <div
                        ...
                        >
                          ...
                          <div className="services-description">
                            ...
                            <p>
                              Datta Able is first ever admin dashboard template
                              which release in Bootstrap 4 framework. Intuitive
                              feature rich design concept and color combination.
                            </p>
                          </div>
                        </div>
                      </div>
              ...
              <div className="container">
                <div className="flex-split">
                  ...
                  <div className="f-right wow fadeInUp" data-wow-delay="0.2s">
                    <div className="right-content">
                      ...
                      <p>
                        Datta Able is full flexible solution for your entire
                        project development. You can easily maintain all of its
                        module/components.
                      </p>
                      <ul>
                        <li>
                ...
                <div className="flex-split">
                  ...
                  <div className="f-left">
                    <div
                      className="left-content wow fadeInUp"
                      data-wow-delay="0.3s"
                    >
                      <img
                        className="img-fluid"
                  ...
                  <div className="col-md-12 hide">
                    <Carousel className="testimonials owl-carousel owl-theme">
                      <Carousel.Item>
                        ...
                        >
                          <p>
                            Totally flexible admin template. Easy to use and
                            easy to manage all the elements in entire theme.{" "}
                            <br className="hidden-xs" /> Great support team
                            behind this product. Low turnaround time with exact
                      ...
                      <Carousel.Item>
                        ...
                        <div className="testimonial-text">
                          <p>
                            The main reason for the Rating for Able pro admin
                            template is that its is awesome template with tons
                            of ready to use features.
                            <br className="hidden-xs" /> - Top quality - Regular
                            updates - PHP version - Clean n Neat code - Saves
                            lots of developing time
                          </p>
                          <h3>Flexibility</h3>
                      ...
                      <Carousel.Item>
                        ...
                        <div className="testimonial-text">
                          <p>
                            5 stars are for the excellent support, that is
                            brilliant! The design is very cool and the quality
                            of code is excellent. <br className="hidden-xs" />
                            Compliments!
                          </p>
                          <h3>Code Quality</h3>
                      ...
                      <Carousel.Item>
                        ...
                        <div className="testimonial-text">
                          <p>
                            ...
                            <br className="hidden-xs" />I would highly
                            recommend.
                          </p>
                  ...
                  <div className="col-md-12 feature_list">
                    <div className="row">
                      ...
                      >
                        ...
                        <p>
                          We increasingly grow our talent and skills in admin
                      ...
                      >
                        ...
                        <p>
                          Documentation helps you in every steps on your entire
                          project.
                        </p>
                      </div>
                      <div
                      ...
                      >
                        ...
                        <p>
                          Fast and accurate outline during support. Low
                          turnaround time.
                        </p>
                      </div>
                    </div>
              ...
              <div className="f-left">
                ...
                >
                  ...
                  <p className="wow fadeInLeft" data-wow-delay="0.2s">
                    We at Datta Able available for custom work development with
                    High end specialized developer.
                  </p>
                  <button
                ...
                <div className="row">
                  <div className="col-md-12 col-sm-12 ">
                    <div className="pricing-intro">
                      ...
                      <p className="wow fadeInUp" data-wow-delay="0.2s">
                        Loream ipsum dummy text loream ipsum dummy text loream
                        ipsum dummy text <br className="hidden-xs" /> loream
                        ipsum dummy text. Get the right plan that suits you.
                      </p>
                    </div>
                    <div className="row">
            ...
            <div className="client-section hide">
