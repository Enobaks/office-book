          ...
          <Card className="Online-Order">
            <Card.Body>
              ...
              <h6 className="text-muted d-flex align-items-center justify-content-between m-t-30">
                Delivery Orders
                <span className="float-right f-18 text-c-green">237 / 400</span>
              </h6>
        ...
        <Col md={6} xl={4}>
          <Card className="Online-Order">
            <Card.Body>
              ...
              <h6 className="text-muted d-flex align-items-center justify-content-between m-t-30">
                pending Orders
                <span className="float-right f-18 text-c-purple">
                  100 / 500
                </span>
              </h6>
              <div className="progress mt-3">
        ...
        <Col xl={4}>
          <Card className="Online-Order">
            <Card.Body>
              ...
              <h6 className="text-muted d-flex align-items-center justify-content-between m-t-30">
                Return Orders
                <span className="float-right f-18 text-c-blue">50 / 400</span>
              </h6>
              <div className="progress mt-3">
                <div
